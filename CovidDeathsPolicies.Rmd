...
*Let's Look Into The Narrow Data*
...
## Technique 1: Divide The Counties Into Clusters
...
## Technique 2: To Find Out if The Policies Mandated in a County Depends on the State It Resides

- In this technique, I am going to investigate if the number of policies mandated in a county is depending on or correspond to the states it resides.
- Which means, if the states have influences to the policy of a county, I will go deeper to look into the trends of each states and see if it has any relationship with the deaths tolls from the Covid-19. 
