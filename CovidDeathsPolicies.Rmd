...
- From the two graphs if I look into the individual glyph, I can say that roughly the counties with low Covid-19 death cases tend to have higher number of Covid-19 policies and counties with high Covid-19 death case tend to have lower number of Covid-19 policies. 
...
- From the Cluster Dendrogram above, we can see that there are two clusters within the cluster 1 itself. 
- Which means, there are some variability 
